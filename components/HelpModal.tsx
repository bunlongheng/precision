...
const TOOLS: [string, string][] = [
  ...
  ["Adjust & filters", "12 one-tap looks plus brightness, contrast, tint, blur and more."],
  ...
  ["Collage", "Pick a layout and fill each cell with a photo."],
];
